export const settingsEn = {
  settings: {
    ...
    integrations: {
      keep: {
        title: 'Google Keep',
        description: 'Mirror a shopping list as a checklist in your personal Google Keep (unofficial, one-way sync).',
        connected: 'Connected as {email}',
        lastSync: 'Last synced {time}',
        disconnect: 'Disconnect',
        confirmDisconnect: 'Disconnect Google Keep? Your Keep notes will not be deleted, but sync will stop.',
        connectSuccess: 'Google Keep connected',
        connectError: 'Failed to connect Google Keep',
        disconnectSuccess: 'Google Keep disconnected',
        disconnectError: 'Failed to disconnect Google Keep',
        mirrorCreated: 'Shopping list linked to a Keep note',
        mirrorError: 'Keep mirror action failed',
        syncSuccess: 'Synced to Google Keep',
        syncError: 'Sync to Google Keep failed',
        instructions: {
          step1: 'Log in to your Google account in a browser.',
          step2: 'Open DevTools → Application → Cookies and copy the "oauth_token" value (or use a master-token helper tool).',
          step3: 'Paste your email and the token below. This is an unofficial integration and may stop working if Google changes something.',
        },
        form: {
          email: 'Google account email',
          masterToken: 'Master token',
          deviceId: 'Device ID (optional)',
          deviceIdPlaceholder: 'Leave empty to generate one',
          emailInvalid: 'Enter a valid email address',
          tokenRequired: 'Master token is required',
          understood: 'I understand this is an unofficial integration and may break without warning. I can revoke access anytime at myaccount.google.com/permissions.',
          revokeHint: 'You can revoke this token anytime at myaccount.google.com/permissions.',
          connect: 'Connect Google Keep',
        },
      },
    },
    delete_account: {
